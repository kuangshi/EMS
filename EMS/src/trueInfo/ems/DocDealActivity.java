...
public class DocDealActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		KGTF = getIntent().getStringExtra("KGTF");
	}
...
//							Toast.LENGTH_SHORT).show();
	...
	public void exitbutton0(View v) {
		...
		{
			Toast.makeText(DocDealActivity.this, "请填写主观题分数！", Toast.LENGTH_SHORT).show();
		}else {
			// 第二步处理文件
			int total = Integer.parseInt(CLYJ)+Integer.parseInt(KGTF);
			CLYJ = total+"";
			doDispose();
		}
